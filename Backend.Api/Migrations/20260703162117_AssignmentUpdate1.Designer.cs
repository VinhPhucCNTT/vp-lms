...
namespace backend.Migrations
{
    ...
    [Migration("20260703162117_AssignmentUpdate1")]
            ...
            modelBuilder.Entity("Backend.Core.Entities.Courses.ModuleResource", b =>
                {
                    ...
                    b.ToTable("module_resources", null, t =>
                        {
                            t.HasCheckConstraint("CK_ModuleResources_Polymorphic_ExactlyOne", "(\"lesson_id\" IS NOT NULL)::int + (\"assignment_id\" IS NOT NULL)::int + (\"assessment_id\" IS NOT NULL)::int + (\"problem_id\" IS NOT NULL)::int = 1");
                        });
                });
