...
import { SearchIcon, PlusIcon, MoreHorizontalIcon, PencilIcon, TrashIcon, UserPlusIcon } from "lucide-react";
    ...
    <div className="space-y-6">
      <PageHeader title="User Management" description="Manage user accounts and permissions" breadcrumbs={[{ label: "Dashboard", href: "/admin" }, { label: "Users" }]} actions={
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          <DialogTrigger asChild><Button><PlusIcon className="size-4 mr-2" />Add User</Button></DialogTrigger>
          <DialogContent>
      ...
      {selectedUsers.length > 0 && (
        <div className="flex items-center gap-2 p-3 bg-muted rounded-lg">
          ...
          <Button size="sm" variant="outline"><UserPlusIcon className="size-4 mr-2" />Assign Role</Button>
          <Button size="sm" variant="outline" className="text-destructive">Suspend Selected</Button>
        </div>
      )}
