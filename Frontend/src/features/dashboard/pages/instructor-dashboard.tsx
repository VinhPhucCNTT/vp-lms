          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                {
                  student: "Alex Chen",
                  assignment: "Algorithm Analysis Practice",
                  course: "CS 101",
                ...
                },
                {
                  ...
                  assignment: "Sorting Implementation",
                  course: "CS 201",
                  submitted: "1 day ago",
                  urgent: false,
                },
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Your courses and their activity
                  </CardDescription>
                </div>
            ...
            <CardContent>
              <div className="space-y-3">
                {announcements.slice(0, 3).map((announcement) => (
                  <div key={announcement.id} className="rounded bg-muted p-2">
