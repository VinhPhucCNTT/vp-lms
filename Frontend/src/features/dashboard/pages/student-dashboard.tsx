  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Here's an overview of your academic progress"
      />
      ...
      <div className="grid gap-6 lg:grid-cols-3">
                ...
                >
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant={
                          item.type === "assignment" ? "secondary" : "info"
                        }
                        className="text-xs"
                      >
                        {item.type}
                  ...
                  <div className="text-right">
                    <p
                      className={`text-sm ${item.urgent ? "font-medium text-destructive" : "text-muted-foreground"}`}
                    >
                      {item.due}
                    </p>
                    {item.urgent && (
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                { label: "CS 101", value: 78 },
                { label: "CS 201", value: 65 },
                { label: "CS 301", value: 42 },
              ].map((item) => (
