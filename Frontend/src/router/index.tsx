...
function StudentRoute() { return <RoleGuard allowedRoles={["student"]} />; }
function InstructorRoute() { return <RoleGuard allowedRoles={["instructor"]} />; }
function AdminRoute() { return <RoleGuard allowedRoles={["admin"]} />; }
function GuestRoute() {
