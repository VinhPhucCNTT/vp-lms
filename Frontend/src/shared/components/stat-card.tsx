          ...
          <div className="space-y-1">
            ...
            {trend && (
              <div className="flex items-center gap-1 pt-1">
                {trend.value >= 0 ? <TrendingUpIcon className="size-3 text-success" /> : <TrendingDownIcon className="size-3 text-destructive" />}
                <Badge variant={trend.value >= 0 ? "success" : "destructive"} className="text-xs">{trend.value >= 0 ? "+" : ""}{trend.value}%</Badge>
